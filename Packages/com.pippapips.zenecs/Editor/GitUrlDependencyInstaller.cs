...
namespace ZenECS.Bootstrap.Editor
{
    [InitializeOnLoad]
    public static class GitUrlDependencyInstaller
    {
        // === 커스터마이즈: 원하는 Git URL 버전으로 변경 ===
        // Extenject 공식 레포(예시): 태그 확인 후 사용
        const string EXTENJECT_NAME    = "com.extenject.zenject";
        const string EXTENJECT_GIT_URL = "https://github.com/svermeulen/Extenject.git?path=UnityProject/Assets/Plugins/Zenject";
        ...
        static GitUrlDependencyInstaller()
        {
